//! Integration tests mirroring Rocksmith2014.IntegrationTests.
//!
//! The .NET project tests end-to-end package building (DLCProject/PackageBuilder)
//! and PSARC import (PsarcImporter), which are not yet ported.  This file covers
//! the portable subset: pure in-memory PSARC round-trip write → read tests that
//! exercise the full create/encrypt/compress/read pipeline.
