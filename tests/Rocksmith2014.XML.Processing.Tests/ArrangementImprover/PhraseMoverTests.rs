...
fn can_move_phrase_beyond_multiple_notes_at_same_time_code() {
    let notes = vec![
        Note { time: 1200, string: 0, ..Default::default() },
        Note { time: 1200, string: 1, ..Default::default() },
        Note { time: 1200, string: 2, ..Default::default() },
        Note { time: 2500, ..Default::default() },
    ];
    let mut arr = InstrumentalArrangement {
        phrases: vec![Phrase { name: "mover2".into(), ..Default::default() }],
        phrase_iterations: vec![PhraseIteration { time: 1000, phrase_id: 0, ..Default::default() }],
...
fn can_move_phrase_on_same_time_code_as_note() {
    let notes = vec![
        ...
        Note { time: 7500, ..Default::default() },
    ];
    let mut arr = InstrumentalArrangement {
        phrases: vec![Phrase { name: "mover2".into(), ..Default::default() }],
        phrase_iterations: vec![PhraseIteration { time: 1000, phrase_id: 0, ..Default::default() }],
...
fn anchor_is_also_moved() {
    let notes = vec![Note { time: 7500, ..Default::default() }];
    let anchors = vec![Anchor { time: 1000, ..Default::default() }];
    let mut arr = InstrumentalArrangement {
        phrases: vec![Phrase { name: "mover1".into(), ..Default::default() }],
        phrase_iterations: vec![PhraseIteration { time: 1000, phrase_id: 0, ..Default::default() }],
        levels: vec![Level { notes, anchors, ..Default::default() }],
        ..Default::default()
    };
    improve_phrase_mover(&mut arr);
...
fn throws_when_no_integer_given() {
    let mut arr = InstrumentalArrangement {
        phrases: vec![Phrase { name: "mover".into(), ..Default::default() }],
        phrase_iterations: vec![PhraseIteration { time: 1000, phrase_id: 0, ..Default::default() }],
        ..Default::default()
    };
    improve_phrase_mover(&mut arr);
