use rocksmith2014_xml::{Anchor, Chord, ChordNote, ChordTemplate, Ebeat, HandShape, InstrumentalArrangement, Level, Note};
...
fn does_not_create_a_phrase_in_the_middle_of_a_handshape() {
    ...
    arr.levels[0].notes.push(Note { time: 2_000, ..Default::default() });
    arr.levels[0].anchors.push(Anchor { fret: 1, time: 2_000, width: 4, end_time: 0 });
    arr.levels[0].chords.push(Chord { time: 8_500, ..Default::default() });
    arr.levels[0].hand_shapes.push(HandShape { chord_id: 0, start_time: 8_500, end_time: 10_800 });
    generate_phrases(&mut arr);
...
fn does_not_create_a_phrase_that_breaks_note_link_next() {
    ...
    arr.levels[0].notes.push(Note { time: 2_000, ..Default::default() });
    arr.levels[0].anchors.push(Anchor { fret: 1, time: 2_000, width: 4, end_time: 0 });
    arr.levels[0].notes.push(Note { time: 9_500, sustain: 500, mask: rocksmith2014_xml::NoteMask::LINK_NEXT, ..Default::default() });
    arr.levels[0].notes.push(Note { time: 10_000, sustain: 1000, ..Default::default() });
    generate_phrases(&mut arr);
...
fn does_not_create_a_phrase_that_breaks_note_link_next_no_sustain_on_linknext_target_note() {
    ...
    arr.levels[0].anchors.push(Anchor { fret: 1, time: 2_000, width: 4, end_time: 0 });
    arr.levels[0].notes.push(Note { time: 9_500, sustain: 500, mask: rocksmith2014_xml::NoteMask::LINK_NEXT, ..Default::default() });
    arr.levels[0].notes.push(Note { time: 10_000, sustain: 0, ..Default::default() });
    generate_phrases(&mut arr);
...
fn does_not_create_a_phrase_that_breaks_note_link_next_multiple_link_next_notes() {
    ...
    arr.levels[0].notes.push(Note { time: 2_000, ..Default::default() });
    arr.levels[0].anchors.push(Anchor { fret: 1, time: 2_000, width: 4, end_time: 0 });
    arr.levels[0].notes.push(Note { time: 9_200, sustain: 300, mask: rocksmith2014_xml::NoteMask::LINK_NEXT, ..Default::default() });
    arr.levels[0].notes.push(Note { time: 9_500, sustain: 500, mask: rocksmith2014_xml::NoteMask::LINK_NEXT, ..Default::default() });
    arr.levels[0].notes.push(Note { time: 10_000, sustain: 500, ..Default::default() });
    generate_phrases(&mut arr);
...
fn does_not_create_a_phrase_that_breaks_chord_link_next() {
    ...
    arr.levels[0].notes.push(Note { time: 2_000, ..Default::default() });
    arr.levels[0].anchors.push(Anchor { fret: 1, time: 2_000, width: 4, end_time: 0 });
    let cn = vec![ChordNote { sustain: 500, mask: rocksmith2014_xml::NoteMask::LINK_NEXT, ..Default::default() }];
    ...
    arr.levels[0].notes.push(Note { time: 10_000, sustain: 700, ..Default::default() });
    // Note: handshape is shorter than chord note sustain
    arr.levels[0].hand_shapes.push(HandShape { chord_id: 0, start_time: 9_500, end_time: 9_800 });
    generate_phrases(&mut arr);
