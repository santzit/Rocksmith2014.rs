...
// testProp "Int16"
le_round_trip!(int16, write_i16, read_i16, [0i16, 1, -1, i16::MIN, i16::MAX, 0x1234]);

// testProp "UInt16"
le_round_trip!(uint16, write_u16, read_u16, [0u16, 1, u16::MAX, 0x1234, 0xABCD]);

// testProp "UInt24"  (3-byte value, fits in u32, max 0xFFFFFF)
le_round_trip!(uint24, write_u24, read_u24, [0u32, 1, 0xFFFFFF, 0x123456, 0x800000]);

// testProp "Int32"
le_round_trip!(int32, write_i32, read_i32, [0i32, 1, -1, i32::MIN, i32::MAX, 0x12345678]);

// testProp "UInt32"
le_round_trip!(uint32, write_u32, read_u32, [0u32, 1, u32::MAX, 0x12345678, 0xDEADBEEF]);

// testProp "UInt40"  (5-byte value, fits in u64, max 0xFFFFFFFFFF)
le_round_trip!(uint40, write_u40, read_u40, [0u64, 1, 0xFF_FFFF_FFFF, 0x12_3456_7890]);

// testProp "UInt64"
le_round_trip!(uint64, write_u64, read_u64, [0u64, 1, u64::MAX, 0x0123456789ABCDEF]);
