...
pub static ALL: &[ToneDescriptor] = &[
    ...
    ToneDescriptor {
        name: "Direct",
        aliases: &["direct"],
        ui_name: "$[35752]DIRECT",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Distortion",
        aliases: &["dist"],
        ui_name: "$[35722]DISTORTION",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Echo",
    ...
    ToneDescriptor {
        ...
        ui_name: "$[35733]EFFECT",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Emulated",
        aliases: &["emu"],
        ui_name: "$[27119]EMULATED",
        is_extra: true,
    },
    ToneDescriptor {
        name: "Filter",
        aliases: &["filter", "wah", "talk"],
        ui_name: "$[35729]FILTER",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Flanger",
        aliases: &["flange"],
        ui_name: "$[35731]FLANGER",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Fuzz",
    ...
    ToneDescriptor {
        name: "Low Output",
        aliases: &["low"],
        ui_name: "$[35732]LOW OUTPUT",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Mandolin",
        aliases: &["mandolin"],
        ui_name: "$[27202]MANDOLIN",
        is_extra: true,
    },
    ToneDescriptor {
        name: "Multi Effect",
        aliases: &["multi"],
        ui_name: "$[35751]MULTI-EFFECT",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Octave",
        aliases: &["8va", "8vb", "oct"],
        ui_name: "$[35719]OCTAVE",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Overdrive",
        aliases: &["od", "drive"],
        ui_name: "$[35716]OVERDRIVE",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Phaser",
        aliases: &["phase"],
        ui_name: "$[35730]PHASER",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Piano",
    ...
    ToneDescriptor {
        ...
        ui_name: "$[35734]PROCESSED",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Reverb",
        aliases: &["verb"],
        ui_name: "$[35726]REVERB",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Rotary",
        aliases: &["roto"],
        ui_name: "$[35725]ROTARY",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Special Effect",
        aliases: &["swell", "organ", "sitar", "sax"],
        ui_name: "$[35750]SPECIAL EFFECT",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Tremolo",
        aliases: &["trem"],
        ui_name: "$[35727]TREMOLO",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Ukulele",
        aliases: &["ukulele", "uke"],
        ui_name: "$[27204]UKULELE",
        is_extra: true,
    },
    ToneDescriptor {
        name: "Vibrato",
        aliases: &["vib"],
        ui_name: "$[35728]VIBRATO",
        is_extra: false,
    },
    ToneDescriptor {
        name: "Vocal",
